...
public class GenericInterfaceDemo {
	...
	public static void main(String[] args) {
		...
		Person p[] = new Person[] { new Person("Nitin", "Pune"), new Person("Sanjivani", "Akola"),
				new Person("Mayur", "Delhi") };
		MinMaxImpl<Person> objThree = new MinMaxImpl<Person>(p); // retrieving Minimum and Maximum element from array of
																	// person objects
