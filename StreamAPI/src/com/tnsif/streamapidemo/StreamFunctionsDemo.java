...
public class StreamFunctionsDemo {
	public static void main(String[] args) {
		...
		// System.out.println("List "+strList+" has "+count+" empty strings");
		  ...
		  filteredList = StreamFunctions.getStrings(strList.stream(), 10);
		  System.out.printf("Original List : %s, Cities length more than 10: %s %n",
		  strList, filteredList);
		  
		  List<Integer> numbers = Arrays.asList(9, 10, 3, 4, 7, 3, 4); // retrieve the Stream
